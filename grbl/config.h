...
//  #define HOMING_CYCLE_0 (1<<X_AXIS)   // CoreXY Compatible: Home X axis first
//  #define HOMING_CYCLE_1 (1<<Y_AXIS)   // CoreXY Compatible: Home Y axis second
...
// #define INVERT_LIMIT_PIN_MASK ((1<<X_LIMIT_BIT)|(1<<Y_LIMIT_BIT)) // Default disabled. Uncomment to enable.
  ...
  //#define INVERT_MAX_LIMIT_PIN_MASK ((1<<X_AXIS) | (1<<Y_AXIS))  
#endif
